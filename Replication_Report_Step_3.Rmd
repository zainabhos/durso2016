...
library(psych)
library(dplyr)
#What other libraries helpful here?#
```


```{r include=F}
####Import data
Pilot1 <- read.csv("/Users/Ikhlas/Downloads/Replication Report 1.csv")
head(Pilot1)
#How do I only look at the summary stats for one variable?# describe by command? 
#### Data exclusion / filtering
summary(Pilot1)
Pilot1New <- Pilot1[ which(Pilot1$Behavioral.Inaction < 10), ] 
head(Pilot1New)

#### Prepare data for analysis - create columns etc. - I had to make alterations in excel in order to consolidate the power and ambivalent states. Should I be creating these columns in r by using gather instead of doing it manually in excel? 
```
...
################################################################################
THIS STEP TO ONLY BE INCLUDED WITH ACTUAL DATA, NOT AS PART OF PILOT A. 
...
fit1 <- manova(cbind(Verbal_Inaction, Behavioral.Inaction) ~ Power.State*Ambivalence_State, data = Pilot1New)
